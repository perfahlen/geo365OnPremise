...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="debug.aspx.cs" Inherits="OpenSMIL.MobileClient.Layouts.OpenSMIL.MobileClient.debug"%>
                ...
                <div style="margin-top: 20px;" class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-sidebar" ng-repeat="layer in layers">
                            <li><div>
                                <a href="#" id="layer-{{layer.Name}}" ng-click="loadLayer(layer, $event);" class="list-group-item" style="float: left; width: 80%;">{{layer.Name}}</a>
